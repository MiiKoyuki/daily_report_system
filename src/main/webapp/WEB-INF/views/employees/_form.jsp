...
<c:set var="commIdx" value="${ForwardCost.CMD_INDEX.getValue()}" />
...
<input type="text" name="${AttributeConst.EMP_CODE.getValue()}" id="${AttributeCost.EMP_CODE.getValue()}" value="${employee.code}" />
<br /><br />
...
<input type="password" name="${AttributeConst.EMP_PASS.getValue()}" id="${AttributeCost.EMP_PASS.getValue()}" />
<br /><br />

<label for="${AttributeConst.EMP_ADMIN_FLG.getValue()}">権限</label><br />
<select name="${AttributeConst.EMP_ADMIN_FLG.getValue()}" id="${AttributeCost.EMP_ADMIN_FLG.getValue()}">
